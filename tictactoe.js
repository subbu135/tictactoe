let btnRef = document.querySelectorAll(".three");
let popupRef = document.querySelector(".popup");
let newgameBtn = document.getElementById("new-game");
let restartBtn = document.getElementById("one");
let msgRef = document.getElementById("message");
let winningPattern = [[0,1,2], [3,4,5], [6,7,8], [0,4,8], [2,4,6], [0,3,6], [1,4,7], [2,5,8]];
let xTurn =true;
let count = 0;
